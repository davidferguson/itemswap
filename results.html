...
<html lang="en">
  ...
  <body>
    ...
    <!-- Main area -->
    <div id="mainContent3" onLoad="body()">
      <div id="lwall" onLoad="left()"></div>
      <div id="rwall" onLoad="right()"></div>
        <div class="searchedItem">
          <img class="searchedImg" src="ntfr-logo.png"/>
          <h1 class="searchedWord">Us</h1>
          <p class="searchedDesc">We cost a lot of money.</p>
          <p class="searchedLoc">Calne,Edinburgh,SN110DW</p>  
        </div>
        <div class="searchedItem">
          <img class="searchedImg" src="ntfr-logo.png"/>
          <h1 class="searchedWord">Us</h1>
